...
vector<pair<State, Action>> InverseOrderedJoinSuccessorGenerator::generate_successors(const vector<ActionSchema> &actions,
                                                                               const State &state,
...
Table InverseOrderedJoinSuccessorGenerator::instantiate(const ActionSchema &action, const State &state,
                                                 const StaticInformation &staticInformation) {
    /*
