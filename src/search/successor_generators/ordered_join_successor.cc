...
vector<pair<State, Action>> OrderedJoinSuccessorGenerator::generate_successors(const vector<ActionSchema> &actions,
                                                                         const State &state,
...
Table OrderedJoinSuccessorGenerator::instantiate(const ActionSchema &action, const State &state,
                                           const StaticInformation &staticInformation) {
    /*
