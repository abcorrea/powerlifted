...
if __name__ == "__main__":
    ...
    xlab = 'State size using enumeration with type constraints'
    ylab = 'State size using overapproximated\nreachability and type constraints'
    generate_scatter_plot(x,y, xlab, ylab)
